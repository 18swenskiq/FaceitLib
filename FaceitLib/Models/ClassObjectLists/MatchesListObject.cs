...
namespace FaceitLib.Models.ClassObjectLists
{
    ...
    public class MatchesListObjectRoot
    {
        ...
        [JsonProperty(PropertyName = "compeitition_id")]
    ...
    public class MatchesListObject : MatchesListObjectRoot
    {
        public Voting Voting { get; set; }
    }

    public class MatchesListObjectTournament : MatchesListObjectRoot
    {
        public List<TournamentMatchesVoting> Voting { get; set; }
    }

    public class TournamentMatchesVoting
    {
        public TournamentVotingDetailsServer Location { get; set; }
        public TournamentVotingDetailsMap Map { get; set; }
    }
